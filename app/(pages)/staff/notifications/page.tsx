        ...
        {loading ? (
          <div className="space-y-2">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-white rounded-2xl border border-slate-100 p-5 animate-pulse flex gap-4"
              >
            ...
            {filtered.map((n) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`w-10 h-10 ${meta.bg} rounded-xl flex items-center justify-center text-lg flex-shrink-0`}
                  >
                    {meta.icon}
                  </div>
                  ...
                  <div className="flex-1 min-w-0 pr-6">
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      {n.link && (
                        <button
                          onClick={() => markRead(n)}
                          className="text-xs text-[#7A1B0F] hover:text-[#5f140b] font-semibold transition"
                        >
                          View →
                        </button>
                      )}
