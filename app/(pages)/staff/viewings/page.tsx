...
function StatusBadge({ status }: { status: string }) {
  ...
  return (
    <span
      className={`inline-flex px-2.5 py-0.5 rounded-lg text-xs font-semibold capitalize border ${
  ...
  useEffect(() => {
    fetch("/api/viewing-request")
      .then(async (r) => {
        ...
        if (!r.ok) {
          throw new Error(data.message || "Failed to load viewing requests");
        }
    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1 ml-3">
            Review and respond to room viewing requests from guests.
          </p>
        </div>
                          ...
                          <td className="px-5 py-4">
                            ...
                            >
                              ...
                              <a
                                href={
                                  req.user?.phone
                                    ? `https://wa.me/${req.user.phone.replace(
                                        /\D/g,
                                        ""
                                      )}`
                                    : "#"
                            ...
                            >
                              <div className="flex flex-wrap gap-6 text-sm text-slate-600 mb-3">
                                ...
                                <div>
                                  ...
                                  KSh{" "}
                                  {req.room?.pricePerNight?.toLocaleString(
                                    "en-KE"
                                  )}
                                  {" / night"}
                                </div>
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between text-sm text-slate-500 gap-4">

            <span>
              Page {page} of {totalPages} — showing{" "}
              {paginated.length} of {filtered.length} requests
            </span>
