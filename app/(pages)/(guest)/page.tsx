...
function getRoomImage(room: Room): string {
  if (room.images?.length > 0 && room.images[0].url) {
...
const STEPS = [
  {
    ...
    title: "Browse Rooms",
    description:
      "Explore our range of rooms filtered by type, price, and capacity.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Schedule a visit to see the room in person before committing.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
  ...
  },
  {
    ...
    title: "Book & Move In",
    description:
      "Confirm your booking online and move in on your chosen date.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
...
const PERKS = [
  {
    ...
    desc: "Your reservation is protected end-to-end.",
  },
  {
    emoji: "💳",
  ...
  },
  {
    emoji: "🏠",
    title: "Quality Rooms",
    desc: "Every room is verified and well-maintained.",
  },
  {
    emoji: "📞",
    title: "24/7 Support",
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 lg:py-28">
          <div className="max-w-2xl">
            ...
            <p
              ...
              style={{ color: "#F3D8D4" }}
            >
              Browse verified, comfortable rooms across the city. Book
              instantly, move in on your schedule.
            </p>

            <div className="flex flex-wrap gap-3">
              <Link
                href="/rooms"
                className="px-6 py-3 bg-white font-semibold rounded-xl hover:bg-gray-100 transition shadow-md"
                style={{ color: "#7A1B0F" }}
              >
                Browse Rooms →
              </Link>
            ...
            <div className="flex flex-wrap gap-8 mt-12">
              {[
                ...
                {
                  value: `${[...new Set(rooms.map((r) => r.type))].length} types`,
                  label: "Room Types",
                },
              ].map((s) => (
                <div key={s.label}>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
          ...
          <Link
            ...
            style={{ color: "#7A1B0F" }}
            onMouseEnter={(e) =>
              (e.currentTarget.style.color = "#63150C")
            }
            onMouseLeave={(e) =>
              (e.currentTarget.style.color = "#7A1B0F")
            }
          >
            View all rooms →
          </Link>
        ...
        <div className="flex gap-2 flex-wrap mb-8">
          {ROOM_TYPES.map((type) => (
            <button
              ...
              onMouseEnter={(e) => {
                if (activeType !== type) {
                  e.currentTarget.style.borderColor = "#C98E85";
                  e.currentTarget.style.color = "#7A1B0F";
                }
              }}
              onMouseLeave={(e) => {
        ...
        {!loading && featured.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500">
              No available rooms for this type. Try another filter.
            </p>

            <button
              onClick={() => setActiveType("All")}
              className="mt-4 px-5 py-2 text-white rounded-lg text-sm font-medium transition"
              style={{ backgroundColor: "#7A1B0F" }}
              onMouseEnter={(e) =>
                (e.currentTarget.style.backgroundColor = "#63150C")
              }
              onMouseLeave={(e) =>
                (e.currentTarget.style.backgroundColor = "#7A1B0F")
              }
            >
              Show All
            </button>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-52 overflow-hidden">
                    ...
                    {/* Type */}
                    <span
                      className="absolute top-3 left-3 px-2.5 py-1 text-white text-xs font-bold rounded-full capitalize"
                      style={{ backgroundColor: "#7A1B0F" }}
                    >
                      {room.type}
                    </span>
                    ...
                    >
                      <span
                        className="px-4 py-2 bg-white text-sm font-semibold rounded-full shadow-lg"
                        style={{ color: "#7A1B0F" }}
                      >
                        View Details →
                      </span>
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: isHovered ? "#63150C" : "#7A1B0F",
                      }}
                    >
                      View Details
                    </div>
        ...
        {!loading && rooms.length > 6 && (
          <div className="text-center mt-10">
            <Link
              href="/rooms"
              className="inline-block px-8 py-3 border-2 font-semibold rounded-xl transition"
              style={{
                borderColor: "#7A1B0F",
                color: "#7A1B0F",
              }}
            ...
            >
              View All {rooms.filter((r) => r.isAvailable).length} Available
              Rooms
            </Link>
          </div>
        )}
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 text-sm">
            We make finding and booking a room simple and stress-free.
          </p>
        </div>
      ...
      >
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link
              href="/rooms"
              className="px-7 py-3 bg-white font-semibold rounded-xl hover:bg-gray-100 transition shadow-md"
              style={{ color: "#7A1B0F" }}
            >
              Browse Rooms
            </Link>
